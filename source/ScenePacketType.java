...
public class ScenePacketType
{
	...
	static final void decodeScenePacket(ScenePacketType type, int i) {
		...
		if (type == aClass401_4445) {
			...
			if (client.aClass495_10935.method6037((byte) -103).method5911(-258518980)
					|| (i_16_ >= 0 && i_17_ >= 0 && i_16_ < client.aClass495_10935.method6029((short) 4373)
							&& i_17_ < client.aClass495_10935.method5967(-202821655)))
			...
			if (-1453744879 * client.anInt11025 != i_23_) {
				boolean bool = (i_21_ >= 0 && i_19_ >= 0 && i_21_ < client.aClass495_10935.method6029((short) 11216)
						&& i_19_ < client.aClass495_10935.method5967(-476995539));
				if (bool || client.aClass495_10935.method6037((byte) -7).method5911(-94213487)) {
			...
			if (client.aClass692_11042 != null) {
				...
				if (null != class528_sub2) {
					...
					if (i_29_ >= 0 && i_27_ >= 0 && (i_29_ < client.aClass495_10935.method6029((short) 28965))
							&& (i_27_ < client.aClass495_10935.method5967(925431184)))
			...
			if (client.aClass495_10935.method6037((byte) -102) != Class489.aClass489_5499) {
				if (i_35_ >= 0 && i_36_ >= 0 && i_35_ < client.aClass495_10935.method6029((short) 5196)
						&& i_36_ < client.aClass495_10935.method5967(148221239)) {
					int i_44_ = 1 + i_39_;
			...
			boolean bool = (i_50_ >= 0 && i_48_ >= 0 && i_50_ < client.aClass495_10935.method6029((short) 24948)
					&& i_48_ < client.aClass495_10935.method5967(2016423593));
			if (bool || client.aClass495_10935.method6037((byte) -59).method5911(-1544252217)) {
			...
			if (255 == i_64_)
				i_64_ = -1;
			if (client.aClass495_10935.method6037((byte) -60) != Class489.aClass489_5499) {
				if (i_54_ >= 0 && i_55_ >= 0 && i_54_ < client.aClass495_10935.method6029((short) 9933)
						&& i_55_ < client.aClass495_10935.method5967(995722328) && i_56_ >= 0 && i_57_ >= 0
						&& i_56_ < client.aClass495_10935.method6029((short) 19234)
						&& i_57_ < client.aClass495_10935.method5967(1056215627) && 65535 != i_59_) {
					i_54_ = 512 * i_54_ + 256;
					i_55_ = 256 + 512 * i_55_;
					i_56_ = i_56_ * 512 + 256;
					i_57_ = 512 * i_57_ + 256;
					...
					Class645_Sub1_Sub5_Sub6 class645_sub1_sub5_sub6 = (new Class645_Sub1_Sub5_Sub6(
							client.aClass495_10935.method5973((byte) 60), i_59_, Class149.anInt1687 * -457709349,
			...
			if (null != class528_sub2) {
				...
				if (i_70_ >= 0 && i_68_ >= 0 && i_70_ < client.aClass495_10935.method6029((short) 13890)
						&& i_68_ < client.aClass495_10935.method5967(1038753764))
			...
			if (client.aClass495_10935.method6037((byte) -58) != Class489.aClass489_5499) {
				if (i_74_ >= 0 && i_75_ >= 0 && i_74_ < client.aClass495_10935.method6029((short) 8835)
						&& i_75_ < client.aClass495_10935.method5967(533717449)) {
					if (i_76_ == -1) {
						...
						if (i_83_ < 3
								&& client.aClass495_10935.method6006((byte) 0).method5633(i_74_, i_75_, (short) 9800))
							i_83_++;
						Class645_Sub1_Sub5_Sub4 class645_sub1_sub5_sub4 = (new Class645_Sub1_Sub5_Sub4(
								client.aClass495_10935.method5973((byte) 40), i_76_, i_78_,
			...
			if (client.aClass495_10935.method6037((byte) -65) != Class489.aClass489_5499) {
				if (i_101_ >= 0 && i_102_ >= 0 && (i_101_ < client.aClass495_10935.method6029((short) 21672) * 2)
						&& (i_102_ < client.aClass495_10935.method6029((short) 4303) * 2) && i_106_ >= 0 && i_107_ >= 0
						&& (i_106_ < client.aClass495_10935.method5967(992532573) * 2)
						&& (i_107_ < client.aClass495_10935.method5967(878861586) * 2) && i_110_ != 65535) {
					i_101_ = 256 * i_101_;
					i_102_ = 256 * i_102_;
					i_106_ *= 256;
					i_107_ = 256 * i_107_;
			...
			if (client.aClass495_10935.method6037((byte) -86) != Class489.aClass489_5499)
			...
			((Class596) client.aClass495_10935.method5976((short) 10580).method63(i_127_, -583966095))
			...
			if (client.aClass495_10935.method6037((byte) -82).method5911(-431578029)
					|| (i_135_ >= 0 && i_136_ >= 0 && (i_135_ < client.aClass495_10935.method6029((short) 11338))
							&& i_136_ < client.aClass495_10935.method5967(987621770)))
			...
			if (client.aClass495_10935.method6037((byte) -96) != Class489.aClass489_5499)
			...
			if (client.aClass495_10935.method6037((byte) -57) != Class489.aClass489_5499) {
				if (i_144_ >= 0 && i_145_ >= 0 && (i_144_ < client.aClass495_10935.method6029((short) 13245))
						&& (i_145_ < client.aClass495_10935.method5967(-453407764))) {
					int i_153_ = 1 + i_148_;
