...
public abstract class IcmpService implements Runnable
{
    ...
    protected abstract void method1175(int i);
    
    protected abstract void method1176(int i, int i_2_, int i_3_);
    
    protected abstract void method1177(int i, int i_4_, int i_5_);
}
